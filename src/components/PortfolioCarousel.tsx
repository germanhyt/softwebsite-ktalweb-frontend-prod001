...
const PortfolioCarousel: React.FC<Props> = ({ cases }) => {
    ...
    return (
        <section className="py-16 lg:pb-20 lg:pt-16 ">
            <h2
                className="text-center font-nunito text-3xl md:text-4xl font-medium text-black mb-12 lg:mb-16"
            >
                ¿Cuál de nuestras soluciones va mejor con <span
                    className="degradado-c3 font-semibold">tu negocio?</span
                >
            </h2>
            <div className="container mx-auto flex flex-col items-center ">
                ...
                <div className="bg-white rounded-xl shadow p-6 md:p-10 w-full max-w-5xl 2xl:max-w-6xl flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="relative flex-1 flex flex-col items-center gap-4 mb-32 sm:mb-10 md:mb-0">
